({
   ...
   fetchDepValues: function(component, ListOfDependentFields) {
      ...
      for (var i = 0; i < ListOfDependentFields.length; i++) {
         dependentFields.push({
            class: "optionClass",
            label: ListOfDependentFields[i].CarGeneration__c+", "+ListOfDependentFields[i].CarType__c+", "+ListOfDependentFields[i].CarColor__c+", "+ListOfDependentFields[i].Name+", "+ListOfDependentFields[i].TestDriveCarStatus__c,
            value: ListOfDependentFields[i].Id
         });
      }
