({
    ...
    doInit: function(component, event, helper) {
        ...
        helper.fetchPicklistValues(component, 'CompanyCity__c', 'CompanyDistrict__c');
    ...
    onControllerFieldChange: function(component, event, helper) {
        ...
        component.set('v.SelectedAccount.CompanyCity__c' , controllerValueKey);
        // get the map values   
    ...
    onDependentFieldChange: function(component, event, helper) {
        ...
        component.set('v.SelectedAccount.CompanyDistrict__c' , depedentValue);
    }, 
    ...
    clearAll: function(component, event, helper) {
        component.set('v.SelectedAccount.CompanyCity__c', '');
        component.set('v.SelectedAccount.CompanyDistrict__c', '');
